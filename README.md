...
**Статус: Фаза 0.6 — проверка гипотезы.** Ничего готового к использованию пока нет.
Фаза 0 (нод-канвас), Фаза 0.5 (области) и Фаза 0.6 (регионы и `ui_scale`) измерены,
критерии всех трёх держатся в CI.
...
| `crates/blazy-areas` | Области экрана: дерево сплитов, регионы, `ui_scale` |
